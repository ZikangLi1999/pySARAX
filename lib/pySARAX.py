...
from dataBox import _PERIODIC_TABLE, _INDENT, _BULK_TEMP, _GROUP_STRUCTURE
...
class Core:
    ...
    def toTULIP(self) -> str:
        ...
        tulipList.append("{:<22}{}".format("geo_kind", geom_kind))
        tulipList.append("\n")
    ...
    def toLAVENDER(self) -> str:
        ...
        slist.append("{:<16}{:<16}{:<16}".format("!", "power(MWth)", "(n,gamma)heating"))
